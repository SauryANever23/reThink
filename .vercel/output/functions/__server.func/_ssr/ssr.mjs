...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BJ8l8CrP.mjs");
...
var manifest = {
	"0e4855404190be99f6bb3be799a6a566508c15f01b550107c4de99536197d4d2": {
		functionName: "generateRecommendation_createServerFn_handler",
		importer: () => import("./api-DnBn6ZnU.mjs")
	},
	"4c379969150198f4ca48a83bec4c02a94fbed9ae3fb57e8eb155161b28d4b863": {
		functionName: "getCatalog_createServerFn_handler",
		importer: () => import("./api-DnBn6ZnU.mjs")
	},
	"704c2ab8850cce902be47f3f66a25a8b8aa330163244e274f357f5d2683f9010": {
		functionName: "applyWhatIf_createServerFn_handler",
		importer: () => import("./api-DnBn6ZnU.mjs")
	},
	"89113a70e32c250386cf5d8c659eed2432cb418baca99290dbbc3ce71e5f18e6": {
		functionName: "explainDecision_createServerFn_handler",
		importer: () => import("./api-DnBn6ZnU.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CVffjsMI.mjs").then((n) => n.t),
